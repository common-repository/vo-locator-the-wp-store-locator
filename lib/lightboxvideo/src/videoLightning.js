(function() {
  ...
  (function(document) {
    ...
    if (typeof jQuery !== 'undefined') {
      return jQuery.fn.jqueryVideoLightning = function(options) {
        this.each(function() {
          var inst;
          if (!jQuery.data(this, 'plugin_jqueryVideoLightning')) {
            inst = new VideoLightning({
              el: this,
              opts: options
            });
            vlData.instances.push(inst);
            jQuery.data(this, 'plugin_jqueryVideoLightning', inst);
          }
        });
        return _initYTAPI();
      };
